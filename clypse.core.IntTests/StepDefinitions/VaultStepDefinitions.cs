...
public sealed class VaultStepDefinitions(TestContext testContext)
{
    ...
    {
        this.testContext.AwsAccessKey = Environment.GetEnvironmentVariable("CLYPSE_INTTEST_AWS_ACCESSKEY") !;
    }

    [Given("aws secret access key loaded from environment variable")]
    public void AwsSecretAccessKeyLoadedFromEnvironmentVariable()
    {
        this.testContext.SecretAccessKey = Environment.GetEnvironmentVariable("CLYPSE_INTTEST_AWS_SECRETACCESSKEY") !;
    }

    [Given("aws bucket name loaded from environment variable")]
    public void AwsBucketNameLoadedFromEnvironmentVariable()
    {
        this.testContext.BucketName = Environment.GetEnvironmentVariable("CLYPSE_INTTEST_AWS_BUCKETNAME") !;
    }

    [Given("aws region loaded from environment variable")]
    public void AwsRegionLoadedFromEnvironmentVariable()
    {
        this.testContext.Region = Environment.GetEnvironmentVariable("CLYPSE_INTTEST_AWS_BUCKETREGION") !;
    }
